/**
 *  Program that is triggered when a new "Additional Comment" is added to an incident in {@tag Update with scoped app}.
...
(function executeRule(current, previous /*null when async*/ ) {
    ...
    if ("device" === (lastCommentList[1].split(":"))[0]) {
        ...
        try {
            ...
            // Cisco DNA Center Token valid for 60 minutes
